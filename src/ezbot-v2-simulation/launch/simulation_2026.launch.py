...
def generate_launch_description():
    ...
    load_joint_state_broadcaster1=Node(
        ...
        executable='spawner',
        arguments=['joint_state_broadcaster', '--controller-manager', '/robot1/controller_manager', '--controller-manager-timeout', '12',
                    '--switch-timeout', '12'],
                   
        output='screen'
    )

    load_omnidirectional_controller1=Node(
        package='controller_manager',   
        executable='spawner',
        arguments=['omnidirectional_controller', '--controller-manager', '/robot1/controller_manager', '--controller-manager-timeout', '12',
                    '--switch-timeout', '12'],
        output='screen'
    )
