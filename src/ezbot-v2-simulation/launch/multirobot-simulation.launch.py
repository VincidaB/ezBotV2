...
def generate_launch_description():
    ...
    bridge = Node(package='ros_gz_bridge', executable='parameter_bridge',
                arguments=['/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock',
                            ...
                            'robot1/camera1_segm/colored_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot2/camera1_segm/colored_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot1/camera1_segm/labels_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot2/camera1_segm/labels_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot1/camera2_segm/colored_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot2/camera2_segm/colored_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot1/camera2_segm/labels_map@sensor_msgs/msg/Image@gz.msgs.Image',
                            'robot2/camera2_segm/labels_map@sensor_msgs/msg/Image@gz.msgs.Image',
