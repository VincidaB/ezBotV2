#ifndef EZBOT_PROPULSION_GAZEBO_PLUGIN_PRIVATE_HPP_
#define EZBOT_PROPULSION_GAZEBO_PLUGIN_HPP_
...
{
class ezbotPropulsionGazeboPluginPrivate
{
  public:
  ...
  /// Distance between the wheels, in meters ie radius of circle going through all 2 of them.
   ...
   * 
   * TODO : Update calculation of wheel velocities from mecanum to omniwheel
  */
