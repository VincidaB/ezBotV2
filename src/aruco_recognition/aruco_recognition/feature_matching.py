...
class featureMatching(Node):
    ...
    def __init__(self):
        ...
        # height: 720
        # 0 distortion
        # intrinsic:  k: 369.50206756591797  k: 0  k: 640  k: 0  k: 369.50210094451904  k: 360  k: 0  k: 0  k: 1
        # projection: projection {  p: 369.50206756591797  p: 0  p: 640  p: 0  p: 0  p: 369.50210094451904  p: 360  p: 0  p: 0  p: 0  p: 1  p: 0

        self.mtx = np.array([[369.50206756591797, 0, 640], [0, 369.50210094451904, 360], [0, 0, 1]])
    ...
    def mask_callback(self, msg):
        ...
        # currently not automated but the images must come in the order of the cameras definition in the xacro file
        self.display_images()
